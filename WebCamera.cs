 ...
 // Create a child window with capCreateCaptureWindowA so you can display it in a picturebox.
    ...
    public void SaveImage(string PName)
    {
        ...
        if (data.GetDataPresent(typeof(System.Drawing.Bitmap)))
        {
         ...
         {
             if (PName == null)
                 filename = @Application.StartupPath + "\\InvalidEntries\\" + DateTime.Now.Date.Day.ToString() + "-" + DateTime.Now.Date.Month + "-" + DateTime.Now.Year.ToString() + "  " + DateTime.Now.TimeOfDay.Hours.ToString() + "-" + DateTime.Now.TimeOfDay.Minutes.ToString() + "-" + DateTime.Now.TimeOfDay.Seconds.ToString() + ".Bmp";
             else
                 filename = @Application.StartupPath + "\\ProfileImages\\" + PName + ".Bmp";


         oImage.Save(filename, System.Drawing.Imaging.ImageFormat.Bmp);
         }
         catch (Exception ex)
         {
